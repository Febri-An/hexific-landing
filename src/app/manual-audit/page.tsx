  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <button
        type="submit"
        disabled={loading}
        className="submit-button w-full py-4 px-6 rounded-lg relative z-10 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
      >
        {loading ? (
    ...
    <div className="manual-audit-container">
      ...
      <div className="cta-section max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/"
            className="cta-button-primary bg-lime-400 px-8 py-4 rounded-lg inline-block"
          >
